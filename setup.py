...
if __name__ == "__main__":
    package_name = "offregister_docker"
    ...
    setup(
        ...
        author=__author__,
        version=__version__,
        description="Docker deployment module for Fabric (offregister)",
        classifiers=[
        ...
        data_files=[
            ...
            (_centos_install_dir(), list(map(_centos_join, listdir(_centos_join())))),
        ],
    )
